...
#define USBD_MANUFACTURER_STRING      "AUTONOMOUS"
#define USBD_PRODUCT_HS_STRING        "AUTONOMOUS MICROPHONE ARRAY"
#define USBD_SERIALNUMBER_HS_STRING   "00000000034E"
#define USBD_PRODUCT_FS_STRING        "AUTONOMOUS MICROPHONE ARRAY"
