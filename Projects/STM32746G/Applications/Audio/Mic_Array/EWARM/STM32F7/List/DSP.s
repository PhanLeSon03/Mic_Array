...
??DFT_1:
        ...
        BL       __aeabi_f2d
        LDR.W    R2,??DataTable12  ;; 0x5a7ed197
        LDR.W    R3,??DataTable12_1  ;; 0x401921fb
...
??Decimation_4:
        ...
        B.N      ??Decimation_7
??Decimation_8:
        VLDR.W   S1,??DataTable9  ;; 0xc2c80000
        VSUB.F32 S1,S1,S0
        VLDR.W   S2,??DataTable9_1  ;; 0x43480000
        VDIV.F32 S1,S1,S2
        VADD.F32 S0,S1,S0
        VSTR     S0,[R1, #0]
??Decimation_9:
...
??Decimation_7:
        ...
        LSLS     LR,R7,#+31
        BPL.N    ??Decimation_8
        VLDR.W   S1,??DataTable9_2  ;; 0x42c80000
        VSUB.F32 S1,S1,S0
        VLDR.W   S2,??DataTable9_1  ;; 0x43480000
        VDIV.F32 S1,S1,S2
        VADD.F32 S0,S1,S0
...
??Window_1:
        LDR.W    R0,??DataTable12_7  ;; 0x447a0000
        STR      R0,[R4, R5, LSL #+2]
...
//  450 		                      );
        ...
        BL       __aeabi_dmul
        MOVS     R2,#+0
        LDR.W    R3,??DataTable12_8  ;; 0x404f8000
          CFI FunCall __aeabi_ddiv
        BL       __aeabi_ddiv
        VMOV     D0,R0,R1
          CFI FunCall cos
        ...
        MOV      R7,R1
        MOVS     R0,#+0
        LDR.W    R1,??DataTable12_9  ;; 0x3ff00000
        VMOV     R2,R3,D8
          CFI FunCall __aeabi_dsub
        BL       __aeabi_dsub
        MOVS     R2,#+0
        LDR.W    R3,??DataTable12_10  ;; 0x3fe00000
          CFI FunCall __aeabi_dmul
        BL       __aeabi_dmul
        MOV      R2,R6
        MOV      R3,R7
...
??Precalculation_3:
        ...
        ADD      R4,R1,R2, LSL #+9
        CMP      R5,#+32768
        BLT.N    ??Precalculation_6
        MOVW     R5,#+32767
        STRH     R5,[R4, R3, LSL #+1]
        B.N      ??Precalculation_5
??Precalculation_6:
        CMN      R5,#+32768
        BGE.N    ??Precalculation_4
        LDR.W    R5,??DataTable12_12  ;; 0xffff8000
        STRH     R5,[R4, R3, LSL #+1]
        B.N      ??Precalculation_5
//  631         }
//  632     }
...
??lowpassFIR_4:
        ...
        MOV      R2,R0
        MOV      R3,R1
        LDR.W    R0,??DataTable12  ;; 0x5a7ed197
        LDR.W    R1,??DataTable12_1  ;; 0x401921fb
          CFI FunCall __aeabi_dmul
        BL       __aeabi_dmul
        MOV      R8,R0
        MOV      R9,R1
        ...
        MOV      R3,R1
        LDR.W    R0,??DataTable12  ;; 0x5a7ed197
        LDR.W    R1,??DataTable12_13  ;; 0x400921fb
          CFI FunCall __aeabi_dmul
        BL       __aeabi_dmul
        MOV      R2,R0
        MOV      R3,R1
...
??CrssCor_7:
        ...
        BGE.N    ??CrssCor_3
        ADD      R6,R12,R8
        LDRSH    R6,[R11, R6, LSL #+1]
        LDRSH    R7,[R10, R8, LSL #+1]
        SMULBB   R6,R6,R7
        SDIV     R6,R6,LR
        ADDS     R0,R0,R6
        ADCS     R1,R1,R6, ASR #+31
        ADD      R8,R8,#+1
        UXTH     R8,R8
        B.N      ??CrssCor_7
//  712 	         
...
// 
//  3 664 bytes of CODE memory (+ 128 bytes shared)
