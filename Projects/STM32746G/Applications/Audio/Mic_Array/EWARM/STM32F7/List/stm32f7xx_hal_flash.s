...
//    Endian       =  little
//    Source file  =  
//        D:\sop1hc\Github\data\Mic_Array_V00\Mic_Array\Drivers\STM32F7xx_HAL_Driver\Src\stm32f7xx_hal_flash.c
//    Command line =  
//        D:\sop1hc\Github\data\Mic_Array_V00\Mic_Array\Drivers\STM32F7xx_HAL_Driver\Src\stm32f7xx_hal_flash.c
...
//        ARM_MATH_CM7
//    List file    =  
//        D:\sop1hc\Github\data\Mic_Array_V00\Mic_Array\Projects\STM32746G\Applications\Audio\Mic_Array\EWARM\STM32F7\List\stm32f7xx_hal_flash.s
//
///////////////////////////////////////////////////////////////////////////////
...
HAL_FLASH_Unlock:
        LDR.N    R0,??DataTable12_3  ;; 0x40023c04
        LDR      R1,[R0, #+12]
        CMP      R1,#+0
...
//  507     FLASH->KEYR = FLASH_KEY1;
        LDR.N    R1,??DataTable12_4  ;; 0x45670123
        STR      R1,[R0, #+0]
//  508     FLASH->KEYR = FLASH_KEY2;
        LDR.N    R1,??DataTable12_5  ;; 0xcdef89ab
        B.N      ?Subroutine0
//  509   }
//  510   else
//  511   {
...
//  539     FLASH->OPTKEYR = FLASH_OPT_KEY1;
        LDR.N    R1,??DataTable12_7  ;; 0x8192a3b
        STR      R1,[R0, #+0]
//  540     FLASH->OPTKEYR = FLASH_OPT_KEY2;
        LDR.N    R1,??DataTable12_8  ;; 0x4c5d6e7f
        B.N      ?Subroutine0
//  541   }
//  542   else
//  543   {
...
//  621   pFlash.ErrorCode = HAL_FLASH_ERROR_NONE;
        MOVS     R0,#+0
        LDR.N    R1,??DataTable12
        LDR.N    R6,??DataTable12_2  ;; 0x40023c0c
        STR      R0,[R1, #+24]
//  622   
