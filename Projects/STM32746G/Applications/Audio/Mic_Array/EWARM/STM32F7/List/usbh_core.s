///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.50.2.10312/W32 for ARM      27/Feb/2016  00:32:48
...
//  402   switch (phost->gState)
        ...
        DATA
??USBH_Process_0:
        DC16     0xB,0x10E,0x1A,0x101
        DC16     0x10E,0x4F,0xD9,0x71
        DC16     0x7D,0x90,0xF8
        THUMB
//  403   {
//  404   case HOST_IDLE :
...
//  613   switch (phost->EnumState)
        ...
        DATA
??USBH_HandleEnum_0:
        DC8      0x4,0x2A,0x47,0x78
        DC8      0x81,0x8C,0xAF,0xD2
        THUMB
//  614   {
//  615   case ENUM_IDLE:  
