///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.50.2.10312/W32 for ARM      27/Feb/2016  00:32:36
...
??HAL_I2C_Master_Transmit_10:
        CMP      R8,#+255
        BLE.N    ??HAL_I2C_Master_Transmit_11
//  564         {
...
//  581       if(hi2c->ErrorCode == HAL_I2C_ERROR_AF)
        LDR      R0,[R4, #+4]
        CMP      R0,#+4
        BNE.N    ??HAL_I2C_Master_Transmit_13
//  582       {
...
//  595     I2C_RESET_CR2(hi2c);
        LDR      R0,[R5, #+0]
        LDR      R1,[R0, #+4]
        LDR.W    R2,??DataTable7  ;; 0xfe00e800
        ANDS     R1,R2,R1
        STR      R1,[R0, #+4]
//  596 
...
??HAL_I2C_Master_Receive_9:
        CMP      R8,#+255
        BLE.N    ??HAL_I2C_Master_Receive_10
//  678         {
...
//  996     if(Size > 255)
        CMP      R3,#+255
        BLE.N    ??HAL_I2C_Master_Transmit_IT_3
//  997     {
//  998       hi2c->XferSize = 255;
        MOVS     R0,#+255
        STRH     R0,[R4, #+40]
        B.N      ??HAL_I2C_Master_Transmit_IT_4
//  999     }
// 1000     else
// 1001     {
...
??HAL_I2C_Master_Transmit_IT_4:
        ...
        LDRH     R0,[R4, #+42]
        CMP      R2,R0
        BCS.N    ??HAL_I2C_Master_Transmit_IT_5
// 1008     {
// 1009       I2C_TransferConfig(hi2c,DevAddress,hi2c->XferSize, I2C_RELOAD_MODE, I2C_GENERATE_START_WRITE);
        ...
        MOV      R0,R4
          CFI FunCall I2C_TransferConfig
        BL       I2C_TransferConfig
        B.N      ??HAL_I2C_Master_Transmit_IT_6
// 1010     }
// 1011     else
// 1012     {
...
// 1068     if(Size > 255)
        CMP      R3,#+255
        BLE.N    ??HAL_I2C_Master_Receive_IT_3
// 1069     {
// 1070       hi2c->XferSize = 255;
        MOVS     R0,#+255
        STRH     R0,[R4, #+40]
        B.N      ??HAL_I2C_Master_Receive_IT_4
// 1071     }
// 1072     else
// 1073     {
...
??HAL_I2C_Master_Receive_IT_4:
        ...
        LDRH     R0,[R4, #+42]
        CMP      R2,R0
        BCS.N    ??HAL_I2C_Master_Receive_IT_5
// 1080     {
...
// 1239     if(Size > 255)
        CMP      R3,#+255
        BLE.N    ??HAL_I2C_Master_Transmit_DMA_3
// 1240     {
// 1241       hi2c->XferSize = 255;
        MOVS     R0,#+255
        STRH     R0,[R5, #+40]
        B.N      ??HAL_I2C_Master_Transmit_DMA_4
// 1242     }
// 1243     else
// 1244     {
...
// 1259     if( (hi2c->XferSize == 255) && (hi2c->XferSize < hi2c->XferCount) )
        ...
        LDRH     R0,[R5, #+42]
        CMP      R2,R0
        BCS.N    ??HAL_I2C_Master_Transmit_DMA_5
// 1260     {
...
// 1330     if(Size > 255)
        CMP      R3,#+255
        BLE.N    ??HAL_I2C_Master_Receive_DMA_3
// 1331     {
// 1332       hi2c->XferSize = 255;
        MOVS     R0,#+255
        STRH     R0,[R5, #+40]
        B.N      ??HAL_I2C_Master_Receive_DMA_4
// 1333     }
// 1334     else
// 1335     {
...
// 1350     if( (hi2c->XferSize == 255) && (hi2c->XferSize < hi2c->XferCount) )
        ...
        LDRH     R0,[R5, #+42]
        CMP      R2,R0
        BCS.N    ??HAL_I2C_Master_Receive_DMA_5
// 1351     {
...
// 1419     if(I2C_WaitOnFlagUntilTimeout(hi2c, I2C_FLAG_ADDR, RESET, I2C_TIMEOUT_ADDR) != HAL_OK)      
        ...
        BL       I2C_WaitOnFlagUntilTimeout
        CMP      R0,#+0
        BEQ.N    ??HAL_I2C_Slave_Transmit_DMA_3
// 1420     {
...
// 1664     I2C_RESET_CR2(hi2c);
        LDR      R0,[R6, #+0]
        LDR      R1,[R0, #+4]
        LDR.N    R2,??DataTable7  ;; 0xfe00e800
        ANDS     R1,R2,R1
        STR      R1,[R0, #+4]
// 1665 
...
??HAL_I2C_Mem_Write_IT_5:
        LDRH     R2,[R4, #+40]
        CMP      R2,#+255
        BNE.N    ??HAL_I2C_Mem_Write_IT_7
        LDRH     R0,[R4, #+42]
        CMP      R2,R0
        BCS.N    ??HAL_I2C_Mem_Write_IT_7
// 1881     {
...
??HAL_I2C_Mem_Read_IT_5:
        LDRH     R2,[R4, #+40]
        CMP      R2,#+255
        BNE.N    ??HAL_I2C_Mem_Read_IT_7
        LDRH     R0,[R4, #+42]
        CMP      R2,R0
        BCS.N    ??HAL_I2C_Mem_Read_IT_7
// 1973     {
...
??HAL_I2C_Mem_Write_DMA_9:
        ...
        BL       I2C_WaitOnTXISFlagUntilTimeout
        CMP      R0,#+0
        BEQ.N    ??HAL_I2C_Mem_Write_DMA_10
// 2084     {
...
// 2297       if (I2C_Trials++ == Trials)
        ...
        STR      R1,[SP, #+0]
        CMP      R0,R6
        BNE.N    ??HAL_I2C_IsDeviceReady_11
// 2298       {
// 2299         /* Generate Stop */
...
// 2588     if((hi2c->XferSize == 0)&&(hi2c->XferCount!=0))
        LDRH     R1,[R4, #+40]
        CMP      R1,#+0
        BNE.N    ??I2C_MasterTransmit_ISR_4
        LDRH     R1,[R4, #+42]
        CMP      R1,#+0
        BEQ.N    ??I2C_MasterTransmit_ISR_4
// 2589     {
...
??I2C_MasterTransmit_ISR_3:
        LDR      R1,[R0, #+24]
        LSLS     R1,R1,#+25
        BPL.N    ??I2C_MasterTransmit_ISR_6
// 2614   {
// 2615     if(hi2c->XferCount == 0)
        LDRH     R1,[R4, #+42]
        CMP      R1,#+0
        BNE.N    ??I2C_MasterTransmit_ISR_7
// 2616     {
// 2617       /* Generate Stop */
...
// 2639     I2C_RESET_CR2(hi2c);
        LDR      R0,[R4, #+0]
        LDR      R1,[R0, #+4]
        LDR.W    R2,??DataTable18  ;; 0xfe00e800
        ANDS     R1,R2,R1
        STR      R1,[R0, #+4]
// 2640 
...
// 2646     if(hi2c->State == HAL_I2C_STATE_MEM_BUSY_TX)
        ...
        CMP      R0,#+82
        MOV      R0,R4
        BNE.N    ??I2C_MasterTransmit_ISR_9
// 2647     {
...
// 2695     if((hi2c->XferSize == 0)&&(hi2c->XferCount!=0))
        LDRH     R1,[R4, #+40]
        CMP      R1,#+0
        BNE.N    ??I2C_MasterReceive_ISR_4
        LDRH     R1,[R4, #+42]
        CMP      R1,#+0
        BEQ.N    ??I2C_MasterReceive_ISR_4
// 2696     {                  
...
??I2C_MasterReceive_ISR_3:
        LDR      R1,[R0, #+24]
        LSLS     R1,R1,#+25
        BPL.N    ??I2C_MasterReceive_ISR_6
// 2721   {
// 2722     if(hi2c->XferCount == 0)
        LDRH     R1,[R4, #+42]
        CMP      R1,#+0
        BNE.N    ??I2C_MasterReceive_ISR_7
// 2723     {
// 2724       /* Generate Stop */
...
// 3111       if(hi2c->XferCount > 255)
        LDRH     R0,[R4, #+42]
        CMP      R0,#+255
        BLE.N    ??I2C_DMAMasterTransmitCplt_5
// 3112       {
// 3113         hi2c->XferSize = 255;
        MOVS     R0,#+255
        STRH     R0,[R4, #+40]
        B.N      ??I2C_DMAMasterTransmitCplt_6
// 3114       }
// 3115       else
// 3116       {
...
// 3127       if( (hi2c->XferSize == 255) && (hi2c->XferSize < hi2c->XferCount) )
        LDRH     R2,[R4, #+40]
        CMP      R2,#+255
        BNE.N    ??I2C_DMAMasterTransmitCplt_7
        LDRH     R0,[R4, #+42]
        CMP      R2,R0
        BCS.N    ??I2C_DMAMasterTransmitCplt_7
// 3128       {
// 3129         I2C_TransferConfig(hi2c,DevAddress,hi2c->XferSize, I2C_RELOAD_MODE, I2C_NO_STARTSTOP);
        ...
        MOV      R0,R4
          CFI FunCall I2C_TransferConfig
        BL       I2C_TransferConfig
        B.N      ??I2C_DMAMasterTransmitCplt_8
// 3130       }
// 3131       else
// 3132       {
...
??I2C_DMAMasterTransmitCplt_8:
        ...
        BL       I2C_WaitOnTXISFlagUntilTimeout
        CMP      R0,#+0
        BEQ.N    ??I2C_DMAMasterTransmitCplt_9
// 3138       {
...
// 3143           if(hi2c->ErrorCode == HAL_I2C_ERROR_AF)
        ...
        CMP      R0,#+4
        LDR      R0,[R4, #+56]
        BNE.N    ??I2C_DMAMasterTransmitCplt_11
// 3144           {
// 3145             hi2c->ErrorCode |= HAL_I2C_ERROR_AF;
        ORR      R0,R0,#0x4
        STR      R0,[R4, #+56]
        B.N      ??I2C_DMAMasterTransmitCplt_10
// 3146           }
// 3147           else
// 3148           {
...
??I2C_DMAMasterTransmitCplt_0:
        ...
        BL       I2C_WaitOnSTOPFlagUntilTimeout
        CMP      R0,#+0
        BEQ.N    ??I2C_DMAMasterTransmitCplt_12
// 3176     {
// 3177       if(hi2c->ErrorCode == HAL_I2C_ERROR_AF)
        LDR      R0,[R4, #+56]
        CMP      R0,#+4
        LDR      R0,[R4, #+56]
        BNE.N    ??I2C_DMAMasterTransmitCplt_13
// 3178       {
// 3179         hi2c->ErrorCode |= HAL_I2C_ERROR_AF;
        ORR      R0,R0,#0x4
        STR      R0,[R4, #+56]
        B.N      ??I2C_DMAMasterTransmitCplt_12
// 3180       }
// 3181       else
// 3182       {
...
// 3201     if(hi2c->ErrorCode != HAL_I2C_ERROR_NONE)
        ...
        CMP      R0,#+0
        MOV      R0,R4
        BEQ.N    ??I2C_DMAMasterTransmitCplt_14
// 3202     {
...
// 3318       if(hi2c->XferCount > 255)
        LDRH     R0,[R4, #+42]
        CMP      R0,#+255
        BLE.N    ??I2C_DMAMasterReceiveCplt_5
// 3319       {
// 3320         hi2c->XferSize = 255;
        MOVS     R0,#+255
        STRH     R0,[R4, #+40]
        B.N      ??I2C_DMAMasterReceiveCplt_6
// 3321       }
// 3322       else
// 3323       {
...
// 3334       if( (hi2c->XferSize == 255) && (hi2c->XferSize < hi2c->XferCount) )
        LDRH     R2,[R4, #+40]
        CMP      R2,#+255
        BNE.N    ??I2C_DMAMasterReceiveCplt_7
        LDRH     R0,[R4, #+42]
        CMP      R2,R0
        BCS.N    ??I2C_DMAMasterReceiveCplt_7
// 3335       {
// 3336         I2C_TransferConfig(hi2c,DevAddress,hi2c->XferSize, I2C_RELOAD_MODE, I2C_NO_STARTSTOP);
        ...
        MOV      R0,R4
          CFI FunCall I2C_TransferConfig
        BL       I2C_TransferConfig
        B.N      ??I2C_DMAMasterReceiveCplt_8
// 3337       }
// 3338       else
// 3339       {
...
??I2C_DMAMasterReceiveCplt_8:
        ...
        BL       I2C_WaitOnFlagUntilTimeout
        CMP      R0,#+0
        BEQ.N    ??I2C_DMAMasterReceiveCplt_9
// 3345       {
...
// 3356           if(hi2c->ErrorCode == HAL_I2C_ERROR_AF)
        ...
        CMP      R0,#+4
        LDR      R0,[R4, #+56]
        BNE.N    ??I2C_DMAMasterReceiveCplt_12
// 3357           {
// 3358             hi2c->ErrorCode |= HAL_I2C_ERROR_AF;
        ORR      R0,R0,#0x4
        STR      R0,[R4, #+56]
        B.N      ??I2C_DMAMasterReceiveCplt_11
// 3359           }
// 3360           else
// 3361           {
...
// 3391       if(hi2c->ErrorCode == HAL_I2C_ERROR_AF)
        ...
        CMP      R0,#+4
        LDR      R0,[R4, #+56]
        BNE.N    ??I2C_DMAMasterReceiveCplt_14
// 3392       {
// 3393         hi2c->ErrorCode |= HAL_I2C_ERROR_AF;
        ORR      R0,R0,#0x4
        STR      R0,[R4, #+56]
        B.N      ??I2C_DMAMasterReceiveCplt_13
// 3394       }
// 3395       else
// 3396       {
...
// 3415     if(hi2c->ErrorCode != HAL_I2C_ERROR_NONE)
        ...
        CMP      R0,#+0
        MOV      R0,R4
        BEQ.N    ??I2C_DMAMasterReceiveCplt_15
// 3416     {
...
// 3533       if(hi2c->XferCount > 255)
        LDRH     R0,[R4, #+42]
        CMP      R0,#+255
        BLE.N    ??I2C_DMAMemTransmitCplt_5
// 3534       {
// 3535         hi2c->XferSize = 255;
        MOVS     R0,#+255
        STRH     R0,[R4, #+40]
        B.N      ??I2C_DMAMemTransmitCplt_6
// 3536       }
// 3537       else
// 3538       {
...
// 3549       if( (hi2c->XferSize == 255) && (hi2c->XferSize < hi2c->XferCount) )
        LDRH     R2,[R4, #+40]
        CMP      R2,#+255
        BNE.N    ??I2C_DMAMemTransmitCplt_7
        LDRH     R0,[R4, #+42]
        CMP      R2,R0
        BCS.N    ??I2C_DMAMemTransmitCplt_7
// 3550       {
...
??I2C_DMAMemTransmitCplt_8:
        ...
        BL       I2C_WaitOnTXISFlagUntilTimeout
        CMP      R0,#+0
        BEQ.N    ??I2C_DMAMemTransmitCplt_9
// 3560       {
...
// 3565           if(hi2c->ErrorCode == HAL_I2C_ERROR_AF)
        ...
        CMP      R0,#+4
        LDR      R0,[R4, #+56]
        BNE.N    ??I2C_DMAMemTransmitCplt_11
// 3566           {
// 3567             hi2c->ErrorCode |= HAL_I2C_ERROR_AF;
        ORR      R0,R0,#0x4
        STR      R0,[R4, #+56]
        B.N      ??I2C_DMAMemTransmitCplt_10
// 3568           }
// 3569           else
// 3570           {
...
??I2C_DMAMemTransmitCplt_0:
        ...
        BL       I2C_WaitOnSTOPFlagUntilTimeout
        CMP      R0,#+0
        BEQ.N    ??I2C_DMAMemTransmitCplt_12
// 3598     {
// 3599       if(hi2c->ErrorCode == HAL_I2C_ERROR_AF)
        LDR      R0,[R4, #+56]
        CMP      R0,#+4
        LDR      R0,[R4, #+56]
        BNE.N    ??I2C_DMAMemTransmitCplt_13
// 3600       {
// 3601         hi2c->ErrorCode |= HAL_I2C_ERROR_AF;
        ORR      R0,R0,#0x4
        STR      R0,[R4, #+56]
        B.N      ??I2C_DMAMemTransmitCplt_12
// 3602       }
// 3603       else
// 3604       {
...
// 3623     if(hi2c->ErrorCode != HAL_I2C_ERROR_NONE)
        ...
        CMP      R0,#+0
        MOV      R0,R4
        BEQ.N    ??I2C_DMAMemTransmitCplt_14
// 3624     {
...
// 3689       if(hi2c->XferCount > 255)
        LDRH     R0,[R4, #+42]
        CMP      R0,#+255
        BLE.N    ??I2C_DMAMemReceiveCplt_5
// 3690       {
// 3691         hi2c->XferSize = 255;
        MOVS     R0,#+255
        STRH     R0,[R4, #+40]
        B.N      ??I2C_DMAMemReceiveCplt_6
// 3692       }
// 3693       else
// 3694       {
...
// 3705       if( (hi2c->XferSize == 255) && (hi2c->XferSize < hi2c->XferCount) )
        LDRH     R2,[R4, #+40]
        CMP      R2,#+255
        BNE.N    ??I2C_DMAMemReceiveCplt_7
        LDRH     R0,[R4, #+42]
        CMP      R2,R0
        BCS.N    ??I2C_DMAMemReceiveCplt_7
// 3706       {
...
// 3727           if(hi2c->ErrorCode == HAL_I2C_ERROR_AF)
        ...
        CMP      R0,#+4
        LDR      R0,[R4, #+56]
        BNE.N    ??I2C_DMAMemReceiveCplt_12
// 3728           {
// 3729             hi2c->ErrorCode |= HAL_I2C_ERROR_AF;
        ORR      R0,R0,#0x4
        STR      R0,[R4, #+56]
        B.N      ??I2C_DMAMemReceiveCplt_11
// 3730           }
// 3731           else
// 3732           {
...
// 3741         I2C_RESET_CR2(hi2c);
        LDR      R0,[R4, #+0]
        LDR      R1,[R0, #+4]
        LDR.N    R2,??DataTable18  ;; 0xfe00e800
        ANDS     R1,R2,R1
        STR      R1,[R0, #+4]
// 3742       
...
// 3761       if(hi2c->ErrorCode == HAL_I2C_ERROR_AF)
        ...
        CMP      R0,#+4
        LDR      R0,[R4, #+56]
        BNE.N    ??I2C_DMAMemReceiveCplt_14
// 3762       {
// 3763         hi2c->ErrorCode |= HAL_I2C_ERROR_AF;
        ORR      R0,R0,#0x4
        STR      R0,[R4, #+56]
        B.N      ??I2C_DMAMemReceiveCplt_13
// 3764       }
// 3765       else
// 3766       {
...
// 3785     if(hi2c->ErrorCode != HAL_I2C_ERROR_NONE)
        ...
        CMP      R0,#+0
        MOV      R0,R4
        BEQ.N    ??I2C_DMAMemReceiveCplt_15
// 3786     {
...
// 3890       if((Timeout == 0)||((HAL_GetTick() - tickstart ) > Timeout))
        CMP      R5,#+0
        BEQ.N    ??I2C_WaitOnTXISFlagUntilTimeout_3
          CFI FunCall HAL_GetTick
        BL       HAL_GetTick
        SUBS     R0,R0,R6
        CMP      R5,R0
...
// 4090   hi2c->Instance->CR2 = tmpreg;  
        LDR.N    R5,??DataTable18_1  ;; 0xfc009800
        ANDS     R4,R5,R4
        LSLS     R1,R1,#+22
...
// 
// 8 628 bytes in section .text
// 
// 8 628 bytes of CODE memory
//
//Errors: none
//Warnings: none
