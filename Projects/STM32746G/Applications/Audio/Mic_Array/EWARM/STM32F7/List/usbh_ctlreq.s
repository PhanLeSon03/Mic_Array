...
//    Endian       =  little
//    Source file  =  
//        D:\sop1hc\Github\data\Mic_Array_V00\Mic_Array\Middlewares\ST\STM32_USB_Host_Library\Core\Src\usbh_ctlreq.c
//    Command line =  
//        D:\sop1hc\Github\data\Mic_Array_V00\Mic_Array\Middlewares\ST\STM32_USB_Host_Library\Core\Src\usbh_ctlreq.c
...
//        ARM_MATH_CM7
//    List file    =  
//        D:\sop1hc\Github\data\Mic_Array_V00\Mic_Array\Projects\STM32746G\Applications\Audio\Mic_Array\EWARM\STM32F7\List\usbh_ctlreq.s
//
///////////////////////////////////////////////////////////////////////////////
...
?Subroutine0:
        MOVS     R2,#+0
        MOVS     R1,#+0
          CFI FunCall USBH_SetAddress USBH_CtlReq
          CFI FunCall USBH_SetCfg USBH_CtlReq
          CFI FunCall USBH_SetInterface USBH_CtlReq
          CFI FunCall USBH_ClrFeature USBH_CtlReq
        B.N      USBH_CtlReq
...
//  587   switch (phost->Control.state)
        ...
        SUBS     R1,R1,#+1
        CMP      R1,#+10
        BHI.N    ??USBH_HandleControl_1
        TBB      [PC, R1]
        DATA
??USBH_HandleControl_0:
        DC8      0x6,0xD,0x21,0x2A
        DC8      0x34,0x3E,0x53,0x5C
        DC8      0x6A,0x74,0x85,0x0
        THUMB
//  588   {
//  589   case CTRL_SETUP:
