///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.50.2.10312/W32 for ARM      27/Feb/2016  00:32:31
...
//  646         if((Timeout == 0)||((HAL_GetTick() - tickstart ) > Timeout))
        CMP      R5,#+0
        BEQ.N    ??HAL_DMA2D_PollForTransfer_3
          CFI FunCall HAL_GetTick
        BL       HAL_GetTick
        SUBS     R0,R0,R6
        CMP      R5,R0
...
??HAL_DMA2D_PollForTransfer_5:
        ...
        LDR      R1,[R0, #+4]
        LSLS     R1,R1,#+27
        BMI.N    ??HAL_DMA2D_PollForTransfer_4
//  669     {
...
??HAL_DMA2D_PollForTransfer_6:
        CMN      R5,#+1
        BEQ.N    ??HAL_DMA2D_PollForTransfer_5
//  682       {
//  683         if((Timeout == 0)||((HAL_GetTick() - tickstart ) > Timeout))
        ...
        SUBS     R0,R0,R6
        CMP      R5,R0
        BCS.N    ??HAL_DMA2D_PollForTransfer_5
//  684         {
...
//  978   if(LayerIdx == 0)
        LDR      R4,[R0, #+0]
        LDR.N    R5,??DataTable2_1  ;; 0xffff00ef
        LDR      R6,[SP, #+12]
        CMP      R6,#+0
