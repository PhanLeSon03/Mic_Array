...
//    Endian       =  little
//    Source file  =  
//        D:\sop1hc\Github\data\Mic_Array_V00\Mic_Array\Drivers\STM32F7xx_HAL_Driver\Src\stm32f7xx_hal_ltdc.c
//    Command line =  
//        D:\sop1hc\Github\data\Mic_Array_V00\Mic_Array\Drivers\STM32F7xx_HAL_Driver\Src\stm32f7xx_hal_ltdc.c
...
//        ARM_MATH_CM7
//    List file    =  
//        D:\sop1hc\Github\data\Mic_Array_V00\Mic_Array\Projects\STM32746G\Applications\Audio\Mic_Array\EWARM\STM32F7\List\stm32f7xx_hal_ltdc.s
//
///////////////////////////////////////////////////////////////////////////////
...
??HAL_LTDC_IRQHandler_2:
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI (cfiCond6) Function HAL_LTDC_IRQHandler
...
?Subroutine7:
        ...
        MOVS     R0,#+4
          ...
          CFI (cfiCond8) Function HAL_LTDC_IRQHandler
...
??HAL_LTDC_ConfigCLUT_1:
        ...
        CMP      R7,#+6
        ITTE     EQ 
        ADDEQ    R7,R5,R5, LSL #+4
        ORREQ    R6,R6,R7, LSL #+24
        ORRNE    R6,R6,R5, LSL #+24
...
?Subroutine0:
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI (cfiCond26) Function HAL_LTDC_SetWindowPosition
          CFI (cfiCond26) Conditional ??CrossCallReturnLabel_8
          CFI (cfiCond26) R4 Frame(CFA, -16)
          CFI (cfiCond26) R5 Frame(CFA, -12)
          CFI (cfiCond26) R6 Frame(CFA, -8)
...
//  929 }
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI (cfiCond30) Function HAL_LTDC_SetWindowPosition
          CFI (cfiCond30) Conditional ??CrossCallReturnLabel_4
          CFI (cfiCond30) R4 Frame(CFA, -16)
          CFI (cfiCond30) R5 Frame(CFA, -12)
          CFI (cfiCond30) R6 Frame(CFA, -8)
          CFI (cfiCond30) R14 Frame(CFA, -4)
          CFI (cfiCond30) CFA R13+16
          CFI Block cfiCond31 Using cfiCommon0
          CFI (cfiCond31) Function HAL_LTDC_SetPixelFormat
          ...
          CFI (cfiCond31) CFA R13+16
          CFI Block cfiCond32 Using cfiCommon0
          CFI (cfiCond32) Function HAL_LTDC_SetAlpha
          ...
          CFI (cfiCond33) Function HAL_LTDC_SetAddress
...
?Subroutine3:
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI (cfiCond38) Function HAL_LTDC_SetAlpha
          ...
          CFI (cfiCond38) CFA R13+16
          CFI Block cfiCond39 Using cfiCommon0
          CFI (cfiCond39) Function HAL_LTDC_SetAddress
