...
//  747   I2S1_Init(); /* I2S1   --> SDO12 */
        ...
        STRB     R0,[R4, #+433]
        STRB     R0,[R4, #+434]
        LDR.W    R0,??DataTable20_6  ;; 0x40013000
        STR      R0,[R4, #+200]
        MOVS     R0,#+32
        STR      R0,[R4, #+208]
        MOVS     R0,#+0
...
//  750   I2S2_Init(); /* I2S2   --> SDO34 */
        LDR.W    R0,??DataTable20_7  ;; 0x40003800
        STR      R0,[R4, #+264]
        MOVS     R0,#+32
        STR      R0,[R4, #+272]
        MOVS     R0,#+0
...
//  980   if (hspi->Instance==SPI1)
        LDR.W    R1,??DataTable20_6  ;; 0x40013000
        LDR      R0,[R4, #+0]
        CMP      R0,R1
...
??HAL_SPI_MspInit_0:
        LDR.W    R1,??DataTable20_7  ;; 0x40003800
        CMP      R0,R1
