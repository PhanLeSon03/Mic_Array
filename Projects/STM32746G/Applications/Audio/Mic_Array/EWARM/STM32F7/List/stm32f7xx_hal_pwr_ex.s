...
//    Endian       =  little
//    Source file  =  
//        H:\PhanLeSon\ActivNoise\Microphone\F7\Mic_Array_Project\Mic_Array\Drivers\STM32F7xx_HAL_Driver\Src\stm32f7xx_hal_pwr_ex.c
//    Command line =  
//        H:\PhanLeSon\ActivNoise\Microphone\F7\Mic_Array_Project\Mic_Array\Drivers\STM32F7xx_HAL_Driver\Src\stm32f7xx_hal_pwr_ex.c
...
//        ARM_MATH_CM7
//    List file    =  
//        H:\PhanLeSon\ActivNoise\Microphone\F7\Mic_Array_Project\Mic_Array\Projects\STM32746G\Applications\Audio\Mic_Array\EWARM\STM32F7\List\stm32f7xx_hal_pwr_ex.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  158   PWR->CSR1 |= PWR_CSR1_BRE;
        LDR.N    R4,??DataTable12  ;; 0x40007004
        LDR      R0,[R4, #+0]
        ORR      R0,R0,#0x200
        STR      R0,[R4, #+0]
//  159 
...
//  276   __HAL_PWR_OVERDRIVE_ENABLE();
        LDR.N    R4,??DataTable12_1  ;; 0x40007000
        LDR      R0,[R4, #+0]
        ORR      R0,R0,#0x10000
        STR      R0,[R4, #+0]
//  277 
...
//  434   if(STOPEntry == PWR_SLEEPENTRY_WFI)
        CMP      R4,#+1
        BNE.N    ??HAL_PWREx_EnterUnderDriveSTOPMode_2
//  435   {   
//  436     /* Request Wait For Interrupt */
//  437     __WFI();
        WFI      
        B.N      ??HAL_PWREx_EnterUnderDriveSTOPMode_3
//  438   }
//  439   else
//  440   {
