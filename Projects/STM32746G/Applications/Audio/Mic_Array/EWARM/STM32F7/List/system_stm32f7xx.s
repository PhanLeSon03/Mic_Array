///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.50.2.10312/W32 for ARM      16/Mar/2016  13:41:21
// Copyright 1999-2015 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  
//        D:\sop1hc\Github\data\Mic_Array_V00\USB_STREAMING\Mic_Array\Projects\STM32746G\Applications\Audio\Mic_Array\Src\system_stm32f7xx.c
//    Command line =  
//        D:\sop1hc\Github\data\Mic_Array_V00\USB_STREAMING\Mic_Array\Projects\STM32746G\Applications\Audio\Mic_Array\Src\system_stm32f7xx.c
...
//    List file    =  
//        D:\sop1hc\Github\data\Mic_Array_V00\USB_STREAMING\Mic_Array\Projects\STM32746G\Applications\Audio\Mic_Array\EWARM\STM32F7\List\system_stm32f7xx.s
//
///////////////////////////////////////////////////////////////////////////////
...
SystemInit:
        LDR.N    R0,??DataTable1  ;; 0xe000ed08
//  167   #endif
...
//  176   RCC->CR &= (uint32_t)0xFEF6FFFF;
        LDR.N    R3,??DataTable1_1  ;; 0xfef6ffff
        LDR      R1,[R0, #+128]
        ORR      R1,R1,#0xF00000
        STR      R1,[R0, #+128]
        LDR.N    R1,??DataTable1_2  ;; 0x40023800
        LDR      R2,[R1, #+0]
        ORR      R2,R2,#0x1
        STR      R2,[R1, #+0]
        MOVS     R2,#+0
...
//  179   RCC->PLLCFGR = 0x24003010;
        LDR.N    R2,??DataTable1_3  ;; 0x24003010
        STR      R2,[R1, #+4]
//  180 
...
SystemCoreClockUpdate:
        LDR.N    R0,??DataTable1_4  ;; 0x40023804
        LDR      R1,[R0, #+4]
//  241 
//  242   switch (tmp)
        AND      R1,R1,#0xC
...
??SystemCoreClockUpdate_0:
        LDR.N    R1,??DataTable1_5  ;; 0x17d7840
//  249       break;
...
//  258       if (pllsource != 0)
        ...
        AND      R2,R2,#0x3F
        ITE      NE 
        LDRNE.N  R1,??DataTable1_5  ;; 0x17d7840
        LDREQ.N  R1,??DataTable1_6  ;; 0xf42400
//  259       {
...
??SystemCoreClockUpdate_2:
        LDR.N    R1,??DataTable1_6  ;; 0xf42400
//  274       break;
