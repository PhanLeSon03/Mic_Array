...
//    Endian       =  little
//    Source file  =  
//        H:\PhanLeSon\ActivNoise\Microphone\F7\Mic_Array_Project\Mic_Array\Drivers\STM32F7xx_HAL_Driver\Src\stm32f7xx_hal_sai_ex.c
//    Command line =  
//        H:\PhanLeSon\ActivNoise\Microphone\F7\Mic_Array_Project\Mic_Array\Drivers\STM32F7xx_HAL_Driver\Src\stm32f7xx_hal_sai_ex.c
...
//        ARM_MATH_CM7
//    List file    =  
//        H:\PhanLeSon\ActivNoise\Microphone\F7\Mic_Array_Project\Mic_Array\Projects\STM32746G\Applications\Audio\Mic_Array\EWARM\STM32F7\List\stm32f7xx_hal_sai_ex.s
//
///////////////////////////////////////////////////////////////////////////////
...
??SAI_BlockSynchroConfig_3:
        ...
        CMP      R0,R2
        BEQ.N    ??SAI_BlockSynchroConfig_4
        LDR.N    R2,??DataTable1_1  ;; 0x40015824
        CMP      R0,R2
        BNE.N    ??SAI_BlockSynchroConfig_5
//  131   {
//  132     SAI1->GCR = tmpregisterGCR;
??SAI_BlockSynchroConfig_4:
        LDR.N    R0,??DataTable1_2  ;; 0x40015800
        STR      R1,[R0, #+0]
        BX       LR
//  133   }
//  134   else 
...
??SAI_BlockSynchroConfig_5:
        LDR.N    R0,??DataTable1_3  ;; 0x40015c00
        STR      R1,[R0, #+0]
//  137   }
//  138 }
        BX       LR               ;; return
