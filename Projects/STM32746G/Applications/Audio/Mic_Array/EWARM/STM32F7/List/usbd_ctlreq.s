...
//  123   switch (req->bRequest) 
        ...
        DATA
??USBD_StdDevReq_0:
        DC8      0x11,0x17,0x1A,0x14
        DC8      0x1A,0x8,0x5,0x1A
        DC8      0xE,0xB
...
??USBD_StdEPReq_12:
        ...
        MOV      R2,R1
        LSLS     R2,R2,#+24
        BPL.N    ??USBD_StdEPReq_13
        ADD      R5,R0,#+20
        B.N      ??USBD_StdEPReq_14
??USBD_StdEPReq_13:
        ADD      R5,R0,#+260
...
??USBD_GetDescriptor_0:
        DC8      0x4,0x1F,0x30,0x78
        DC8      0x78,0x62,0x6C,0x0
        THUMB
//  339   { 
...
//  505     switch (pdev->dev_state) 
        LDRB     R0,[R4, #+508]
        CMP      R0,#+2
        BEQ.N    ??USBD_SetConfig_1
        CMP      R0,#+3
        BEQ.N    ??USBD_SetConfig_2
        B.N      ??USBD_SetConfig_0
//  506     {
...
//  578     switch (pdev->dev_state )  
        LDRB     R2,[R0, #+508]
        CMP      R2,#+2
        BEQ.N    ??USBD_GetConfig_1
        CMP      R2,#+3
        BEQ.N    ??USBD_GetConfig_2
        B.N      ??USBD_GetConfig_0
//  579     {
