///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.50.2.10312/W32 for ARM      20/Dec/2015  12:46:48
// Copyright 1999-2015 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  
//        H:\PhanLeSon\ActivNoise\Microphone\F7\Mic_Array_Project\Mic_Array\Drivers\STM32F7xx_HAL_Driver\Src\stm32f7xx_hal_tim_ex.c
//    Command line =  
//        H:\PhanLeSon\ActivNoise\Microphone\F7\Mic_Array_Project\Mic_Array\Drivers\STM32F7xx_HAL_Driver\Src\stm32f7xx_hal_tim_ex.c
...
//        ARM_MATH_CM7
//    List file    =  
//        H:\PhanLeSon\ActivNoise\Microphone\F7\Mic_Array_Project\Mic_Array\Projects\STM32746G\Applications\Audio\Mic_Array\EWARM\STM32F7\List\stm32f7xx_hal_tim_ex.s
//
///////////////////////////////////////////////////////////////////////////////
...
??Subroutine3_0:
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI (cfiCond10) Function HAL_TIMEx_HallSensor_Stop_IT
          ...
          CFI (cfiCond11) Function HAL_TIMEx_HallSensor_Stop_DMA
...
?Subroutine13:
        ...
        MOVS     R2,#+0
          ...
          CFI (cfiCond13) Function HAL_TIMEx_HallSensor_Start
...
??Subroutine13_0:
        MOVS     R1,#+0
        LDR      R0,[R4, #+0]
          CFI (cfiCond9) FunCall HAL_TIMEx_HallSensor_Stop TIM_CCxChannelCmd
          CFI (cfiCond10) FunCall HAL_TIMEx_HallSensor_Stop_IT TIM_CCxChannelCmd
          CFI (cfiCond11) FunCall HAL_TIMEx_HallSensor_Stop_DMA TIM_CCxChannelCmd
          CFI (cfiCond13) FunCall HAL_TIMEx_HallSensor_Start TIM_CCxChannelCmd
...
//  400     if(((uint32_t)pData == 0 ) && (Length > 0)) 
        CBNZ.N   R6,??HAL_TIMEx_HallSensor_Start_DMA_1
        CBNZ.N   R5,??CrossCallReturnLabel_18
//  401     {
...
//  963 } 
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI (cfiCond25) Function HAL_TIMEx_PWMN_Stop
          ...
          CFI (cfiCond26) Function HAL_TIMEx_OnePulseN_Stop
...
?Subroutine19:
        ...
        MOVS     R2,#+0
        LDR      R0,[R4, #+0]
          CFI (cfiCond24) FunCall HAL_TIMEx_OCN_Stop TIM_CCxNChannelCmd
          CFI (cfiCond25) FunCall HAL_TIMEx_PWMN_Stop TIM_CCxNChannelCmd
          CFI (cfiCond26) FunCall HAL_TIMEx_OnePulseN_Stop TIM_CCxNChannelCmd
        B.N      TIM_CCxNChannelCmd
...
// 1021   TIM_CCxNChannelCmd(htim->Instance, Channel, TIM_CCxN_ENABLE);
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI R4 Frame(CFA, -8)
          CFI R14 Frame(CFA, -4)
          CFI FunCall HAL_TIMEx_OCN_Start TIM_CCxNChannelCmd
          CFI FunCall HAL_TIMEx_PWMN_Start TIM_CCxNChannelCmd
          CFI FunCall HAL_TIMEx_OCN_Start_IT TIM_CCxNChannelCmd
          CFI FunCall HAL_TIMEx_PWMN_Start_IT TIM_CCxNChannelCmd
        THUMB
??Subroutine25_0:
...
// 1105 } 
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI (cfiCond34) Function HAL_TIMEx_PWMN_Stop_IT
          CFI (cfiCond34) Conditional ??CrossCallReturnLabel_33
...
??Subroutine17_0:
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI (cfiCond37) Function HAL_TIMEx_PWMN_Stop_IT
...
??Subroutine10_0:
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI (cfiCond40) Function HAL_TIMEx_PWMN_Stop_IT
...
??Subroutine7_4:
        LDR      R0,[R4, #+0]
        MOVS     R2,#+0
          CFI (cfiCond39) FunCall HAL_TIMEx_OCN_Stop_IT TIM_CCxNChannelCmd
          CFI (cfiCond40) FunCall HAL_TIMEx_PWMN_Stop_IT TIM_CCxNChannelCmd
        B.N      TIM_CCxNChannelCmd
...
// 1153       HAL_DMA_Start_IT(htim->hdma[TIM_DMA_ID_CC1], (uint32_t)pData, (uint32_t)&htim->Instance->CCR1, Length);
        ...
        ADD      R2,R0,#+52
        LDR      R0,[R4, #+32]
          CFI FunCall HAL_TIMEx_OCN_Start_DMA HAL_DMA_Start_IT
          CFI FunCall HAL_TIMEx_PWMN_Start_DMA HAL_DMA_Start_IT
        BL       HAL_DMA_Start_IT
// 1154       
...
??Subroutine6_6:
        ...
        MOVS     R2,#+4
        MOV      R1,R5
          CFI FunCall HAL_TIMEx_OCN_Start_DMA TIM_CCxNChannelCmd
          CFI FunCall HAL_TIMEx_PWMN_Start_DMA TIM_CCxNChannelCmd
        BL       TIM_CCxNChannelCmd
// 1214     
...
??CrossCallReturnLabel_19:
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI (cfiCond45) Function HAL_TIMEx_OCN_Start_DMA
          CFI (cfiCond45) Conditional ??CrossCallReturnLabel_19
          CFI (cfiCond45) R4 Frame(CFA, -16)
          CFI (cfiCond45) R5 Frame(CFA, -12)
          CFI (cfiCond45) R6 Frame(CFA, -8)
          CFI (cfiCond45) R14 Frame(CFA, -4)
          CFI (cfiCond45) CFA R13+16
          CFI Block cfiCond46 Using cfiCommon0
          CFI (cfiCond46) Function HAL_TIMEx_PWMN_Start_DMA
          CFI (cfiCond46) Conditional ??CrossCallReturnLabel_19
...
??Subroutine16_0:
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI (cfiCond54) Function HAL_TIMEx_OCN_Stop_DMA
          CFI (cfiCond54) Conditional ??CrossCallReturnLabel_5
          CFI (cfiCond54) R4 Frame(CFA, -8)
          CFI (cfiCond54) R14 Frame(CFA, -4)
          CFI (cfiCond54) CFA R13+8
          CFI Block cfiCond55 Using cfiCommon0
          CFI (cfiCond55) Function HAL_TIMEx_PWMN_Stop
          ...
          CFI (cfiCond56) Function HAL_TIMEx_PWMN_Stop_DMA
          CFI (cfiCond56) Conditional ??CrossCallReturnLabel_7
          CFI (cfiCond56) R4 Frame(CFA, -8)
          CFI (cfiCond56) R14 Frame(CFA, -4)
          CFI (cfiCond56) CFA R13+8
          CFI Block cfiCond57 Using cfiCommon0
          CFI (cfiCond57) Function HAL_TIMEx_OnePulseN_Stop
          CFI (cfiCond57) Conditional ??CrossCallReturnLabel_8
          CFI (cfiCond57) R4 Frame(CFA, -8)
          CFI (cfiCond57) R14 Frame(CFA, -4)
          CFI (cfiCond57) CFA R13+8
          CFI Block cfiCond58 Using cfiCommon0
          CFI (cfiCond58) Function HAL_TIMEx_OnePulseN_Stop_IT
...
?Subroutine9:
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI (cfiCond61) Function HAL_TIMEx_PWMN_Stop_DMA
...
??Subroutine8_4:
        LDR      R0,[R4, #+0]
        MOVS     R2,#+0
          CFI (cfiCond60) FunCall HAL_TIMEx_OCN_Stop_DMA TIM_CCxNChannelCmd
          CFI (cfiCond61) FunCall HAL_TIMEx_PWMN_Stop_DMA TIM_CCxNChannelCmd
        B.N      TIM_CCxNChannelCmd
...
// 1369 }
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI (cfiCond66) Function HAL_TIMEx_PWMN_Stop
          CFI (cfiCond66) Conditional ??CrossCallReturnLabel_27
          CFI (cfiCond66) R4 Frame(CFA, -8)
          CFI (cfiCond66) R14 Frame(CFA, -4)
          CFI (cfiCond66) CFA R13+8
          CFI Block cfiCond67 Using cfiCommon0
          CFI (cfiCond67) Function HAL_TIMEx_OnePulseN_Stop
          CFI (cfiCond67) Conditional ??CrossCallReturnLabel_28
          CFI (cfiCond67) R4 Frame(CFA, -8)
          CFI (cfiCond67) R14 Frame(CFA, -4)
          CFI (cfiCond67) CFA R13+8
          CFI Block cfiCond68 Using cfiCommon0
          CFI (cfiCond68) Function HAL_TIMEx_OnePulseN_Stop_IT
...
// 1401   } 
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI R4 Frame(CFA, -8)
          CFI R14 Frame(CFA, -4)
          CFI FunCall HAL_TIMEx_OnePulseN_Start TIM_CCxNChannelCmd
          CFI FunCall HAL_TIMEx_OnePulseN_Start_IT TIM_CCxNChannelCmd
        THUMB
?Subroutine2:
        BL       TIM_CCxNChannelCmd
        BL       ?Subroutine14
??CrossCallReturnLabel_24:
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI (cfiCond73) Function HAL_TIMEx_PWMN_Start_DMA
...
// 1562 }
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI (cfiCond81) Function HAL_TIMEx_ConfigCommutationEvent_IT
          CFI (cfiCond81) Conditional ??CrossCallReturnLabel_48
          CFI (cfiCond81) R4 Frame(CFA, -8)
          CFI (cfiCond81) R14 Frame(CFA, -4)
          CFI (cfiCond81) CFA R13+8
          CFI Block cfiCond82 Using cfiCommon0
          CFI (cfiCond82) Function HAL_TIMEx_ConfigCommutationEvent_DMA
          CFI (cfiCond82) Conditional ??CrossCallReturnLabel_49
...
?Subroutine22:
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI (cfiCond85) Function HAL_TIMEx_ConfigCommutationEvent_IT
          CFI (cfiCond85) Conditional ??CrossCallReturnLabel_45
          CFI (cfiCond85) R4 Frame(CFA, -8)
          CFI (cfiCond85) R14 Frame(CFA, -4)
          CFI (cfiCond85) CFA R13+8
          CFI Block cfiCond86 Using cfiCommon0
          CFI (cfiCond86) Function HAL_TIMEx_ConfigCommutationEvent_DMA
          CFI (cfiCond86) Conditional ??CrossCallReturnLabel_46
...
?Subroutine21:
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI (cfiCond89) Function HAL_TIMEx_ConfigCommutationEvent_IT
          ...
          CFI (cfiCond90) Function HAL_TIMEx_ConfigCommutationEvent_DMA
...
// 1875 }
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI (cfiCond97) Function HAL_TIM_PWM_ConfigChannel
          ...
          CFI (cfiCond98) Function HAL_TIM_PWM_ConfigChannel
          ...
          CFI (cfiCond99) Function HAL_TIM_PWM_ConfigChannel
...
?Subroutine24:
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI (cfiCond102) Function HAL_TIM_PWM_ConfigChannel
          CFI (cfiCond102) Conditional ??CrossCallReturnLabel_51
          ...
          CFI (cfiCond103) Function HAL_TIM_PWM_ConfigChannel
          CFI (cfiCond103) Conditional ??CrossCallReturnLabel_52
          ...
          CFI (cfiCond104) Function HAL_TIM_PWM_ConfigChannel
...
?Subroutine23:
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI (cfiCond107) Function HAL_TIM_PWM_ConfigChannel
          CFI (cfiCond107) Conditional ??CrossCallReturnLabel_35
          ...
          CFI (cfiCond108) Function HAL_TIM_PWM_ConfigChannel
          CFI (cfiCond108) Conditional ??CrossCallReturnLabel_36
          CFI (cfiCond108) R4 Frame(CFA, -16)
          CFI (cfiCond108) R5 Frame(CFA, -12)
          CFI (cfiCond108) R6 Frame(CFA, -8)
          CFI (cfiCond108) R14 Frame(CFA, -4)
          CFI (cfiCond108) CFA R13+16
          CFI Block cfiCond109 Using cfiCommon0
          CFI (cfiCond109) Function HAL_TIM_PWM_ConfigChannel
          CFI (cfiCond109) Conditional ??CrossCallReturnLabel_37
          CFI (cfiCond109) R4 Frame(CFA, -16)
          CFI (cfiCond109) R5 Frame(CFA, -12)
          CFI (cfiCond109) R6 Frame(CFA, -8)
...
// 1905   switch (sClearInputConfig->ClearInputSource)
        LDR      R0,[R5, #+4]
        CBZ.N    R0,??HAL_TIM_ConfigOCrefClear_1
        CMP      R0,#+2
        BEQ.N    ??HAL_TIM_ConfigOCrefClear_2
        BCC.N    ??HAL_TIM_ConfigOCrefClear_3
...
??HAL_TIM_ConfigOCrefClear_4:
        CBZ.N    R6,??HAL_TIM_ConfigOCrefClear_6
        CMP      R6,#+4
...
// 2040 }  
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI (cfiCond113) Function HAL_TIM_ConfigOCrefClear
          CFI (cfiCond113) Conditional ??CrossCallReturnLabel_13
          CFI (cfiCond113) R4 Frame(CFA, -16)
          CFI (cfiCond113) R5 Frame(CFA, -12)
          CFI (cfiCond113) R6 Frame(CFA, -8)
          CFI (cfiCond113) R14 Frame(CFA, -4)
          CFI (cfiCond113) CFA R13+16
          CFI Block cfiCond114 Using cfiCommon0
          CFI (cfiCond114) Function HAL_TIM_ConfigOCrefClear
          ...
          CFI (cfiCond115) Function HAL_TIM_ConfigOCrefClear
          CFI (cfiCond115) Conditional ??CrossCallReturnLabel_15
          CFI (cfiCond115) R4 Frame(CFA, -16)
          CFI (cfiCond115) R5 Frame(CFA, -12)
          CFI (cfiCond115) R6 Frame(CFA, -8)
          CFI (cfiCond115) R14 Frame(CFA, -4)
          CFI (cfiCond115) CFA R13+16
          CFI Block cfiCond116 Using cfiCommon0
          CFI (cfiCond116) Function HAL_TIM_ConfigOCrefClear
          CFI (cfiCond116) Conditional ??CrossCallReturnLabel_16
          CFI (cfiCond116) R4 Frame(CFA, -16)
          CFI (cfiCond116) R5 Frame(CFA, -12)
          CFI (cfiCond116) R6 Frame(CFA, -8)
          CFI (cfiCond116) R14 Frame(CFA, -4)
          CFI (cfiCond116) CFA R13+16
          CFI Block cfiCond117 Using cfiCommon0
          CFI (cfiCond117) Function HAL_TIM_ConfigOCrefClear
          CFI (cfiCond117) Conditional ??CrossCallReturnLabel_17
...
// 2071   if (IS_TIM_TRGO2_INSTANCE(htim->Instance))
        LDR.N    R5,??DataTable5_4  ;; 0x40010000
        STRB     R2,[R0, #+56]
        LDR      R2,[R0, #+0]
        CMP      R2,R5
        LDR      R3,[R2, #+4]
        LDR      R4,[R2, #+8]
        ITT      NE 
        LDRNE.N  R5,??DataTable5_5  ;; 0x40010400
        CMPNE    R2,R5
...
// 2389   tmpccmrx |= OC_Config->OCMode;
        LDR.N    R5,??DataTable5_6  ;; 0xfffeff8f
        BIC      R2,R2,#0x10000
        STR      R2,[R0, #+32]
        LDR      R2,[R0, #+32]
        LDR      R3,[R0, #+4]
...
// 2441   tmpccmrx |= (OC_Config->OCMode << 8);
        LDR.N    R5,??DataTable5_7  ;; 0xfeff8fff
        BIC      R2,R2,#0x100000
        STR      R2,[R0, #+32]
        LDR      R2,[R0, #+32]
        LDR      R3,[R0, #+4]
