...
//        ARM_MATH_CM7
//    List file    =  
//        H:\PhanLeSon\ActivNoise\Microphone\F7\Mic_Array_Project\Mic_Array\Projects\STM32746G\Applications\Audio\Mic_Array\EWARM\STM32F7\List\stm32f7xx_hal_pcd.s
//
///////////////////////////////////////////////////////////////////////////////
...
??PCD_WriteEmptyTxFifo_1:
        ...
        UXTH     R0,R0
        CMP      R9,R0
        BCS.N    ??PCD_WriteEmptyTxFifo_4
        LDR      R0,[R7, #+20]
        LDR      R1,[R7, #+24]
        CMP      R1,R0
        BCS.N    ??PCD_WriteEmptyTxFifo_4
        CMP      R0,#+0
        BNE.N    ??PCD_WriteEmptyTxFifo_2
// 1178   
// 1179   if(len <= 0)
??PCD_WriteEmptyTxFifo_4:
        CMP      R8,#+1
        BGE.N    ??PCD_WriteEmptyTxFifo_5
// 1180   {
