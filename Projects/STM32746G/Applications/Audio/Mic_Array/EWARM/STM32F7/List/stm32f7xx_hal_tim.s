///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.50.2.10312/W32 for ARM      27/Feb/2016  00:32:42
...
//  585   if(IS_TIM_ADVANCED_INSTANCE(htim->Instance) != RESET)  
        LDR      R0,[R4, #+0]
        LDR.W    R1,??DataTable17_1  ;; 0x40010000
        CMP      R0,R1
...
// 2095   if(IS_TIM_ADVANCED_INSTANCE(htim->Instance) != RESET)  
        LDR      R0,[R4, #+0]
        LDR.N    R1,??DataTable17_1  ;; 0x40010000
        CMP      R0,R1
...
// 2311   tmpccmr1 |= (sConfig->IC1Filter << 4) | (sConfig->IC2Filter << 12);
        ...
        LDR      R7,[R5, #+24]
        ORR      R3,R3,R7, LSL #+8
        LDR.W    R7,??DataTable23  ;; 0xffff0303
        ANDS     R3,R7,R3
        LDR      R7,[R5, #+12]
        ORRS     R3,R7,R3
        LDR      R7,[R5, #+28]
...
// 3277         htim->Instance->SMCR &= ~TIM_SMCR_SMS;
        LDR      R0,[R4, #+0]
        LDR      R1,[R0, #+8]
        LDR.W    R2,??DataTable31  ;; 0xfffefff8
        ANDS     R1,R2,R1
        STR      R1,[R0, #+8]
...
// 3949   htim->Instance->SMCR = tmpsmcr;
        LDR.W    R3,??DataTable31_2  ;; 0xfffe0088
        ANDS     R2,R3,R2
        STR      R2,[R0, #+8]
// 3950   
...
// 3976       htim->Instance->SMCR = tmpsmcr;
        LDR.W    R1,??DataTable31_3  ;; 0xfffeff88
        ANDS     R1,R1,R2
        ORR      R1,R1,#0x77
        STR      R1,[R0, #+8]
// 3977     }
...
// 4130   htim->Instance->SMCR = tmpsmcr;
        ...
        LDR      R5,[R1, #+4]
        ORRS     R3,R5,R3
        LDR.W    R5,??DataTable31  ;; 0xfffefff8
        ANDS     R3,R5,R3
        LDR      R5,[R1, #+0]
        ORRS     R3,R5,R3
        STR      R3,[R2, #+8]
...
// 4660   if(IS_TIM_CC3_INSTANCE(TIMx) != RESET)   
        LDR.N    R2,??DataTable31_4  ;; 0x40010000
        CMP      R0,R2
        BEQ.N    ??TIM_Base_SetConfig_0
        CMP      R0,#+1073741824
        BEQ.N    ??TIM_Base_SetConfig_0
        LDR.N    R4,??DataTable31_5  ;; 0x40000400
        CMP      R0,R4
        BEQ.N    ??TIM_Base_SetConfig_0
        LDR.N    R4,??DataTable31_6  ;; 0x40000800
        CMP      R0,R4
        BEQ.N    ??TIM_Base_SetConfig_0
        LDR.N    R4,??DataTable31_7  ;; 0x40000c00
        CMP      R0,R4
        BEQ.N    ??TIM_Base_SetConfig_0
        LDR.N    R4,??DataTable31_8  ;; 0x40010400
        CMP      R0,R4
...
??TIM_Base_SetConfig_3:
        ...
        CMP      R0,R4
        BEQ.N    ??TIM_Base_SetConfig_4
        LDR.N    R4,??DataTable31_9  ;; 0x40014000
        CMP      R0,R4
        BEQ.N    ??TIM_Base_SetConfig_4
        LDR.N    R4,??DataTable31_10  ;; 0x40014400
        CMP      R0,R4
        BEQ.N    ??TIM_Base_SetConfig_4
        LDR.N    R4,??DataTable31_11  ;; 0x40014800
        CMP      R0,R4
        BEQ.N    ??TIM_Base_SetConfig_4
        LDR.N    R4,??DataTable31_12  ;; 0x40001800
        CMP      R0,R4
        BEQ.N    ??TIM_Base_SetConfig_4
        LDR.N    R4,??DataTable31_13  ;; 0x40001c00
        CMP      R0,R4
        BEQ.N    ??TIM_Base_SetConfig_4
        LDR.N    R4,??DataTable31_14  ;; 0x40002000
        CMP      R0,R4
...
// 4682   if(IS_TIM_ADVANCED_INSTANCE(TIMx) != RESET)  
        ...
        LDR.N    R2,??DataTable31_8  ;; 0x40010400
        CMP      R0,R2
...
// 4720   tmpccmrx |= OC_Config->OCMode;
        LDR.N    R5,??DataTable31_15  ;; 0xfffeff8c
        ANDS     R3,R5,R3
        LDR      R5,[R1, #+0]
        ORRS     R3,R5,R3
// 4721   
...
// 4728   if(IS_TIM_ADVANCED_INSTANCE(TIMx) != RESET)
        LDR.N    R5,??DataTable31_4  ;; 0x40010000
        CMP      R0,R5
        BEQ.N    ??TIM_OC1_SetConfig_0
        LDR.N    R5,??DataTable31_8  ;; 0x40010400
        CMP      R0,R5
...
// 4786   tmpccmrx |= (OC_Config->OCMode << 8);
        LDR.N    R5,??DataTable31_16  ;; 0xfeff8cff
        ANDS     R3,R5,R3
        LDR      R5,[R1, #+0]
        ORR      R3,R3,R5, LSL #+8
// 4787   
...
// 4980   htim->Instance->SMCR = tmpsmcr;
        ...
        LDR      R4,[R1, #+4]
        ORRS     R3,R4,R3
        LDR.N    R4,??DataTable31  ;; 0xfffefff8
        ANDS     R3,R4,R3
        LDR      R4,[R1, #+0]
        ORRS     R3,R4,R3
        STR      R3,[R2, #+8]
...
// 5116   if(IS_TIM_CC2_INSTANCE(TIMx) != RESET)
        LDR.N    R6,??DataTable31_4  ;; 0x40010000
        CMP      R0,R6
        BEQ.N    ??TIM_TI1_SetConfig_0
        CMP      R0,#+1073741824
        BEQ.N    ??TIM_TI1_SetConfig_0
        LDR.N    R6,??DataTable31_5  ;; 0x40000400
        CMP      R0,R6
        BEQ.N    ??TIM_TI1_SetConfig_0
        LDR.N    R6,??DataTable31_6  ;; 0x40000800
        CMP      R0,R6
        BEQ.N    ??TIM_TI1_SetConfig_0
        LDR.N    R6,??DataTable31_7  ;; 0x40000c00
        CMP      R0,R6
        BEQ.N    ??TIM_TI1_SetConfig_0
        LDR.N    R6,??DataTable31_8  ;; 0x40010400
        CMP      R0,R6
        BEQ.N    ??TIM_TI1_SetConfig_0
        LDR.N    R6,??DataTable31_9  ;; 0x40014000
        CMP      R0,R6
        BEQ.N    ??TIM_TI1_SetConfig_0
        LDR.N    R6,??DataTable31_12  ;; 0x40001800
        CMP      R0,R6
