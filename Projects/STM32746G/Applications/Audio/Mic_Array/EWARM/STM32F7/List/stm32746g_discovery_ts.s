...
??BSP_TS_GetState_9:
        ...
        LDR      R7,[R2, #+12]
        CMP      R7,R3
        BCS.N    ??BSP_TS_GetState_10
        SUBS     R7,R1,R7
        B.N      ??BSP_TS_GetState_11
??BSP_TS_GetState_10:
        SUBS     R7,R7,R1
??BSP_TS_GetState_11:
        LDRH     R12,[R0, R6, LSL #+1]
        MOV      R0,R12
        LDR      LR,[R2, #+32]
        CMP      LR,R0
...
??BSP_TS_GetState_14:
        ...
        LDRB     R0,[R5, #+1]
        CMP      R0,#+112
        BNE.N    ??BSP_TS_GetState_15
        STRH     R1,[R3, #+2]
        STRH     R12,[R3, #+12]
        B.N      ??BSP_TS_GetState_16
??BSP_TS_GetState_15:
        LDRH     R1,[R5, #+2]
        LDR      R7,[R2, #+12]
        MULS     R1,R7,R1
