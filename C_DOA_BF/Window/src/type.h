 ...
 *                            logMMSE
 *----------------------------------------------------------------------------*/
#define samplRate                     16000
#define FRAME_LEN                     1024
//#define samplRate                     (X_INT16)(8000)
//#define FRAME_LEN                     (X_INT16)(20*samplRate/1000)  //160
#define OVERLAP_RATE                  (X_FLOAT32) (0.5)
#define FRAME_SHIFT                   (X_INT16)(FRAME_LEN * OVERLAP_RATE) //80
...
#define NS_FFT_ORDER                    10
#define NS_FFT_LENGTH                   1024
#define NS_FREQUENY_BINS                513
/*----------------------------------------------------------------------------
 *                                  BUFFERING
 *----------------------------------------------------------------------------*/
