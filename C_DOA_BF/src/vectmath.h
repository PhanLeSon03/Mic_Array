...
{                                                                                                           \
    int _i;                                                                                                 \
    for (_i = 0; _i < NDIM/2+1; _i++)                                                                       \
	{                                                                                                       \
        o[_i].real = w[_i].real * s[_i].real + w[_i].imag * s[_i].imag;                                     \
		o[_i].imag = w[_i].real * s[_i].imag - w[_i].imag * s[_i].real;                                     \
		if ((_i!=0)&&(_i!=NDIM/2))                                                                          \
		{                                                                                                   \
            o[NDIM - _i].real = o[_i].real;                                                                 \
		    o[NDIM - _i].imag = -o[_i].imag;                                                                \
		}                                                                                                   \
	}                                                                                                       \
}

//sop1hc
#define CONV2CPLX(d,s)  /* covert from float to complex */              \
{                                                                       \
    int _i;                                                             \
    for (_i = 0; _i < NDIM; _i++)                                       \
	{                                                                   \
	    d[_i].real = (float)s[_i];                                      \
        d[_i].imag = 0.0f;                                              \
	}                                                                   \
}
