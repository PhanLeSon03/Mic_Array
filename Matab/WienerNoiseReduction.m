...
wl = fix(0.0040*fs)    % window length is 20 ms
...
d= (nsum)/count; % noise signal energy which is calculated in FFT domain


%% --------- main algorithm ---------------
SP = 0.5;      % 0.25 Shift percentage is 50 % Overlap-Add method works good with this value
normFactor=1/SP;
