...
//    Endian       =  little
//    Source file  =  
//        D:\sop1hc\Mic\Mic_Array\Mic_Array\Projects\STM32746G\Applications\Audio\Mic_Array\Src\stm32f7xx_it.c
//    Command line =  
//        D:\sop1hc\Mic\Mic_Array\Mic_Array\Projects\STM32746G\Applications\Audio\Mic_Array\Src\stm32f7xx_it.c
...
//    List file    =  
//        D:\sop1hc\Mic\Mic_Array\Mic_Array\Projects\STM32746G\Applications\Audio\Mic_Array\EWARM\STM32F7\List\stm32f7xx_it.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   52 extern __IO uint8_t WaveRecord_flgIni;
...
//  176       flg10ms = 1;
        ...
        MOVS     R1,#+0
        STRB     R2,[R3, #+0]
//  177       if ((cntOS==3000)||(cntOS==6000)||(cntOS==9000))
??SysTick_Handler_0:
        STR      R1,[R0, #+0]
//  178       {
//  179            flgShipping = CheckEnergyEqual(&Buffer1.bufMIC1[0], &Buffer1.bufMIC5[0], 100); 
//  180            WaveRecord_flgIni=0;
//  181       }
//  182   }
//  183   	
//  184 }
...
//  185 
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI NoCalls
        THUMB
//  186 void USART6_IRQHandler(void)
//  187 {
//  188 //  HAL_UART_IRQHandler(&huart6);
//  189 }
USART6_IRQHandler:
        BX       LR               ;; return
...
//  208 
        ...
        THUMB
//  209 void I2C2_EV_IRQHandler(void)
//  210 {
//  211   /* USER CODE BEGIN I2C1_EV_IRQn 0 */
//  212 
//  213   /* USER CODE END I2C1_EV_IRQn 0 */
//  214   HAL_I2C_EV_IRQHandler(&hi2c2);
I2C2_EV_IRQHandler:
        LDR.N    R0,??DataTable4_4
          CFI FunCall HAL_I2C_EV_IRQHandler
        B.W      HAL_I2C_EV_IRQHandler
//  215   /* USER CODE BEGIN I2C1_EV_IRQn 1 */
//  216 
//  217   /* USER CODE END I2C1_EV_IRQn 1 */
//  218 }
...
//  224 
//  225 /******************************************************************************/
//  226 /*                 STM32F7xx Peripherals Interrupt Handlers                   */
...
//  229 /*  file (startup_stm32f7xx.s).                                               */
//  230 /******************************************************************************/
//  231 
//  232 /**
//  233   * @brief  This function handles USB-On-The-Go FS/HS global interrupt request.
//  234   * @param  None
//  235   * @retval None
//  236   */
//  237 #ifdef USE_USB_FS

        SECTION `.text`:CODE:NOROOT(1)
          CFI Block cfiBlock13 Using cfiCommon0
          CFI Function OTG_FS_IRQHandler
        THUMB
//  238 void OTG_FS_IRQHandler(void)
//  239 #else
//  240 void OTG_HS_IRQHandler(void)
//  241 #endif
//  242 {
//  243   //sop1hc HAL_HCD_IRQHandler(&hhcd);
//  244   HAL_PCD_IRQHandler(&hpcd);
OTG_FS_IRQHandler:
...
//  246 
//  247 /**
//  248   * @brief This function handles DMA2 Stream 4 interrupt request.
//  249   * @param None
//  250   * @retval None
//  251   */
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI NoCalls
        THUMB
//  252 void AUDIO_OUT_SAIx_DMAx_IRQHandler(void)
//  253 {
//  254   //HAL_DMA_IRQHandler(haudio_out_sai.hdmatx);
//  255 }
...
//  256 
//  257 /**
//  258   * @brief This function handles DMA2 Stream 7 interrupt request.
//  259   * @param None
//  260   * @retval None
//  261   */
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI NoCalls
        THUMB
//  262 void AUDIO_IN_SAIx_DMAx_IRQHandler(void)
//  263 {
//  264   //HAL_DMA_IRQHandler(haudio_in_sai.hdmarx);
//  265 }
...
//  266 
//  267 /**
//  268   * @brief  This function handles PPP interrupt request.
//  269   * @param  None
//  270   * @retval None
//  271   */
//  272 /*void PPP_IRQHandler(void)
//  273 {
//  274 }*/
//  275 
